...
values (CURRENT_DATE, CURRENT_DATE, 24, '한현수', 1),
       ...
       (CURRENT_DATE, CURRENT_DATE, 22, '김신아', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '김재관', 2),
       (CURRENT_DATE, CURRENT_DATE, 25, '김효중', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '노욱진', 2),
       (CURRENT_DATE, CURRENT_DATE, 25, '백세희', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '이예슬', 2),
       (CURRENT_DATE, CURRENT_DATE, 25, '이은지', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '이진우', 2),
       (CURRENT_DATE, CURRENT_DATE, 25, '이찬균', 2),
       ...
       (CURRENT_DATE, CURRENT_DATE, 22, '김수빈', 3),
       (CURRENT_DATE, CURRENT_DATE, 25, '김유진', 3),
       (CURRENT_DATE, CURRENT_DATE, 22, '김은총', 3),
       (CURRENT_DATE, CURRENT_DATE, 25, '박신영', 3),
