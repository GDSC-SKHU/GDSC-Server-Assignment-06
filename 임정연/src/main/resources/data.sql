...
values (CURRENT_DATE, CURRENT_DATE, 24, '한현수', 1),
       ...
       (CURRENT_DATE, CURRENT_DATE, 23, '노욱진', 2),
       (CURRENT_DATE, CURRENT_DATE, 24, '이진우', 2),
       (CURRENT_DATE, CURRENT_DATE, 23, '이찬균', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '전유진', 2),
       (CURRENT_DATE, CURRENT_DATE, 25, '최재훈', 2),
       (CURRENT_DATE, CURRENT_DATE, 22, '김수빈', 3),
       (CURRENT_DATE, CURRENT_DATE, 22, '김유진', 3),
       (CURRENT_DATE, CURRENT_DATE, 23, '김은총', 3),
